# complaints.csv
# Get this from this link if needed:
# https://catalog.data.gov/dataset/consumer-complaint-database

# to get a list of headers from complaints.csv, type the following: 
# (start a python venv first)
python
>>> import pandas as pd
# If you don't specify dtype = object you will get an error because of the mixed types
>>> data = pd.read_csv('./Desktop/complaints.csv', dtype = object) 
...
This is what will be used for the MapReduce algorithm. See mapper_readme.txt, combiner_readme.txt, and reducer_readme.txt
